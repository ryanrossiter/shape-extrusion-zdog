...
var spacing = function spacing(o) {
  return function (i, v) {
    return {
      x: 0,
      y: Math.sin(v * Math.PI * 2 + o) * 20,
      z: i * 2
    };
  };
};
...
var AnimatedShapeExtrusion = function AnimatedShapeExtrusion(props) {
  ...
  Object(react_zdog__WEBPACK_IMPORTED_MODULE_1__["useRender"])(function () {// _spacing = spacing(Date.now() / 2000);
  });
...
//# sourceMappingURL=index.js.f7188b26331c72efb85d.hot-update.js.map