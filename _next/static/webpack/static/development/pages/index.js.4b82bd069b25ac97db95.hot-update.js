...
var AnimatedShapeExtrusion = function AnimatedShapeExtrusion(props) {
  ...
  Object(react_zdog__WEBPACK_IMPORTED_MODULE_1__["useRender"])(function () {
    ref.current.shapeRefs.forEach(function (shape, i) {
      ...
      var xOff = Math.sin(Date.now() / 1000);
      var yOff = Math.sin(Date.now() / 1000 / 2);
      shape.translate.x = Math.pow(xOff, 2) * Math.sign(xOff) * 200 * v;
      shape.translate.y = Math.pow(yOff, 2) * Math.sign(yOff) * 200 * v;
    });
  });
...
//# sourceMappingURL=index.js.4b82bd069b25ac97db95.hot-update.js.map