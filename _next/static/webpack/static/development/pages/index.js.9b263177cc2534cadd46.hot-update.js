...
var RotatingAnchor = function RotatingAnchor(_ref) {
  ...
  Object(react_zdog__WEBPACK_IMPORTED_MODULE_1__["useRender"])(function () {
    ref.current.rotate.y = Math.sin((Date.now() - window.performance.timing.navigationStart) / 2000) * Math.PI / 2 * 0.9;
    ref.current.rotate.x = Math.cos((Date.now() - window.performance.timing.navigationStart) / 2000) * Math.PI / 2 * 0.9; // ref.current.rotate.y = (Date.now() - window.performance.timing.navigationStart) / 2000;
...
//# sourceMappingURL=index.js.9b263177cc2534cadd46.hot-update.js.map