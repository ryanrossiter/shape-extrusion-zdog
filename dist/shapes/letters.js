...
exports.AmpShape = exports.FShape = exports.KShape = void 0;

var _react = _interopRequireDefault(require("react"));

var _reactZdog = require("react-zdog");

var _makeZdogBezier = _interopRequireDefault(require("../utils/makeZdogBezier"));
...
var K_PATH = (0, _makeZdogBezier["default"])([{
  "x": 240.25,
  "y": 235.271
}, {
  "x": 240.25,
...
var F_PATH = (0, _makeZdogBezier["default"])([{
  "x": 230.314,
  "y": 226.869
}, {
  "x": 230.314,
...
var AMP_OUTER_PATH = (0, _makeZdogBezier["default"])([{
  "x": 22.026,
  "y": 98.771
}, {
  "x": 22.026,
...
var AMP_INNER_PATH_0 = (0, _makeZdogBezier["default"])([{
  "x": 33.292,
  "y": 87.375
}, {
  "x": 33.292,
...
var AMP_INNER_PATH_1 = (0, _makeZdogBezier["default"])([{
  "x": 47.149,
  "y": 40.544
}, {
  "x": 51.173,
...
var LetterShape = function LetterShape(positionProps) {
  ...
  return _react["default"].forwardRef(function (_ref, ref) {
    ...
    return _react["default"].createElement(_reactZdog.Anchor, {
      ...
      translate: translate,
      ref: ref
    }, _react["default"].createElement(_reactZdog.Anchor, positionProps, paths.map(function (path) {
      return _react["default"].createElement(_reactZdog.Shape, _extends({
        path: path
      }, props));
    })));
  });
